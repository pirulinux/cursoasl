...
year=`date +%Y`;
FECHA=$dia-$mes-$year;
reporte=/home/magentotienda/Programacion/Reportes/$FECHA.html
...
#mutt -s "Reporte mañana de $FECHA" denisse_betza@hotmail.com < $reporte
...
#bueno si es infinito se supone que no tiene es mas bien un descanso
